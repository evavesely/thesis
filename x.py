...
for index, row in error_test.iterrows(): 
            if pd.notna(row['text']):
                ...
                system_prompt = '''Assign a gender label to the speaker of this dialogue. Your options are 'm' if they are male, 'f' if they are female, and '?' if you can't tell. Keep in mind that
                ...
                try:
                    ...
                    error_test.at[index, 'gpt_label'] = 'err'
error_test.to_csv('labeled_baseline.csv')
